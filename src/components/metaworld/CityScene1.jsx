...
export function CityScene1(props) {
  const { nodes, materials } = useGLTF("./models/city_c5.glb");
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.LIGHT_STREET2063.geometry}
        material={materials["COLOR.006"]}
...
useGLTF.preload("./models/city_c5.glb");
